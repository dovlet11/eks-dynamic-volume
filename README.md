# EKS : Dynamic Volume Provisionining and Ingress

- Create and Manage EKS Cluster with eksctl.

- Persistent data management

- PersistentVolumes and PersistentVolumeClaims

- Ingress and Ingress Controller Usage
...
- Pay attention that default value for node-type is m5.large.
        ...
        - image: clarusways/todo
          ...
          resources:
            ...
            requests:
              cpu: 80m			  
```
Note that this web app is connnected to MongoDB host/service via the `DBHOST` environment variable. What does `db-service:27017` mean here.
...
- Open the offical [ingress-nginx]( https://kubernetes.github.io/ingress-nginx/deploy/ ) see the `ingress-controller` installation steps for different architecture.
